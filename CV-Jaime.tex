...
\cvline{Nov/2023}{Expositor de la conferencia \textbf{Introducción Práctica a la Tarjeta Microbit} en el \textit{IT de Ciudad Altamirano} en el marco del VI Congreso Nacional de Investigación en Ciencia e Innovación de Tecnologías Productivas, Cd. Altamirano, GRO}
\cvline{Oct/2023}{Expositor de la conferencia \textbf{Introducción al Framework de Desarrollo Laravel} en el \textit{IT de Ciudad Altamirano} en el marco del 41 Aniversario del Instituto Tecnológico de Ciudad Altamirano, Cd. Altamirano, GRO}
\cvline{Oct/2023}{Expositor de la conferencia \textbf{Robótica Educativa como Estrategia para Inducir la Programación} en la \textit{Universidad Intercultural de San Luis Potosí, Campus Tancanhuitz} en el marco del 12o Aniversario de la UICSLP, Tancanhuitz, SLP}
\cvline{Oct/2023}{Expositor del taller \textbf{Programación con Tarjeta Microbit} en el \textit{IT de Ciudad Valles} en el marco del 43 Aniversario del TecNM Campus Ciudad Valles, Cd. Valles, SLP}
...
\cvdoubleitem{Hardware}{Tarjeta Microbit, Lego Mindstorms}{Administración Web}{Intermedio}
